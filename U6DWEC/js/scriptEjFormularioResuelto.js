...
//Funcion cuando le das al check de foro te abre una pagina
  function check1(){
    if(document.getElementById("foro").checked = true){
      window.open("foro.html" , "ventana1" , "width=500,height=500,scrollbars=YES")
    }
  }

  function check2(){
    if(document.getElementById("eventos").checked = true){
      window.open("eventos.html" , "ventana1" , "width=500,height=500,scrollbars=YES")
    }
  }
